package com.eagle.emulator.plus.overlay.citron;
...
public class CitronOverlayHook extends OverlayHook {

    public static final String HOOK_CLASS_NAME = "org.citron.citron_emu.activities.EmulationActivity";

    public CitronOverlayHook(XC_LoadPackage.LoadPackageParam lpparam) {
    ...
    protected String getConfigPath() {
        ...
        return Paths.get(sdcardPath, "Android", "data", HookParams.CITRON, "files", "overlay").toString();
    }
